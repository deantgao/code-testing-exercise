...
def is_mel(name, email):
    ...
    >>> is_mel("Danya Dye", "greengiant@gmail.com")
    False

    >>> is_mel("DD", "mel@ubermelon.com")
    True

    >>> is_mel("Mel Melitpolski", "ss@green.com")
    True
    """
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{"type" : "dessert"}, {"type" : "dessert"}, {"type" : "appetizer"}, {"type" : "appetizer"}, {"type" : "appetizer"}, {"type" : "drink"}])
    ('appetizer', 'drink')
    """
